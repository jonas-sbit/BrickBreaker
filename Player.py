...
class Player:
    ...
    def __init__(self, score=0, lives=6, current_level=1):
        self.score = score
    ...
    def set_lives(self, lives=6):
        """
        description:
            - Set lives to a value considering difficulty
        :param lives: lives to be set
        :return: nothing
        """
        self.lives = lives - DatabaseInteract().get_settings()[7]
